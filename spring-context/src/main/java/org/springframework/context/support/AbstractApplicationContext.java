...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	 ...
	 * 准备刷新, 设置启动时间, 设置启动标志同时准备执行属性源的初始化
	 */
	 ...
	 * 实例化和调用所有注册的BeanPostProcessor, 必须在单例实例化之前调用
	 */
	 ...
	 * 初始化MessageSource, 如果在此上下文中没有定义，则使用父节点的
	 */
	 ...
	 * @see org.springframework.context.event.SimpleApplicationEventMulticaster
	 * 初始化applicationeventmultiaster, 如果上下文中没有定义，则使用SimpleApplicationEventMulticaster
	 */
	 ...
	 * 模板方法, 该方法可被重写以添加特定于上下文的刷新工作, 在实例化单例之前，调用特殊bean的初始化
	 ...
	 * 添加实现ApplicationListener接口的bean作为侦听器, 不会影响其他的侦听器
	 */
